...
Descriptors::Descriptors(Device * device, SwapChain * swapChain, Pipeline * pipeline, UniformBuffers * uniformBuffers) : m_device(device), m_swapChain(swapChain), m_pipeline(pipeline)
{
